...
bool pair_GenVertexPtr_int_greater::operator()(const std::pair<ConstGenVertexPtr, int>& lx, const std::pair<ConstGenVertexPtr, int>& rx) const
{
    ...
    for (const ConstGenParticlePtr& pp: lx.first->particles_in()) lx_id_in.push_back(pp->pid());
    for (const ConstGenParticlePtr& pp: rx.first->particles_in()) rx_id_in.push_back(pp->pid());
    ...
    for (const ConstGenParticlePtr& pp: lx.first->particles_in()) lx_id_out.push_back(pp->pid());
    for (const ConstGenParticlePtr& pp: rx.first->particles_in()) rx_id_out.push_back(pp->pid());
    ...
    for (const ConstGenParticlePtr& pp: lx.first->particles_in()) lx_mom_in.push_back(pp->momentum().e());
    for (const ConstGenParticlePtr& pp: rx.first->particles_in()) rx_mom_in.push_back(pp->momentum().e());
    ...
    for (const ConstGenParticlePtr& pp: lx.first->particles_in()) lx_mom_out.push_back(pp->momentum().e());
    for (const ConstGenParticlePtr& pp: rx.first->particles_in()) rx_mom_out.push_back(pp->momentum().e());
