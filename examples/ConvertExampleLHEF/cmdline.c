/*
  ...
  /usr/bin/gengetopt -N --no-version --input=/home/andriish/Projects/HepMC3/examples/ConvertExampleLHEF/cmdline.ggo --file-name cmdline --output-dir=/home/andriish/Projects/HepMC3/examples/ConvertExampleLHEF --include-getopt --show-required --unnamed-opts=inputfile outputfile 
...
const char *gengetopt_args_info_purpose = "Convert between different file formats of LHE event record.\nExample:\n        convert_example_LHE -i lhef -o lhef input.lhef output.lhef\n";

const char *gengetopt_args_info_usage = "Usage: convert_example_LHEF [OPTION]... [inputfile outputfile]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -i, --input-format=STRING     Input format  (possible values=\"lhef\")\n                                  (mandatory)",
  "  -o, --output-format=STRING    Output format  (possible values=\"lhef\",\n                                  \"none\") (mandatory)",
...
const char *cmdline_parser_input_format_values[] = {"lhef", 0}; /*< Possible values for input-format. */
const char *cmdline_parser_output_format_values[] = {"lhef", "none", 0}; /*< Possible values for output-format. */
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->strict_read_help = gengetopt_args_info_help[3] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hi:o:", long_options, &option_index);
