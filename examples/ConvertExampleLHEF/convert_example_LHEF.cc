...
enum class Format { LHEF, LHEFGZ, LHEFLZMA, LHEFBZ2, LHEFZSTD };

static void print_usage(const char *program) {
    std::cerr << "Usage: " << program << " -i lhef|lhefgz|lheflzma|lhefbz2|lhefzstd -o lhef|lhefgz|lheflzma|lhefbz2|lhefzstd input output\n";
}
