 ...
 void custom_LHEFTagBase_binder (pybind11::class_<LHEF::TagBase, std::shared_ptr<LHEF::TagBase>> cl)
{
 ...
 void custom_LHEFTagBase_binder (pybind11::class_<LHEF::Reader, std::shared_ptr<LHEF::Reader>> cl)
{
		cl.def("initfile_rdstate", (auto (LHEF::Reader::*)() const) &LHEF::Reader::initfile_rdstate, "initfile rdstate\n\nC++: LHEF::Reader::initfile_rdstate() const --> enum std::_Ios_Iostate");
		cl.def("file_rdstate", (auto (LHEF::Reader::*)() const) &LHEF::Reader::file_rdstate, "file rdstate\n\nC++: LHEF::Reader::file_rdstate() const --> enum std::_Ios_Iostate");
