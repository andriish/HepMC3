...
int main()
{
    ReaderAsciiHepMC2 inputA("inputIO11.hepmc");
    ...
    WriterAsciiHepMC2       outputB("fromfrominputIO11.hepmc");
    ...
    inputB.close();
    outputB.close();
    return COMPARE_ASCII_FILES("fromfrominputIO11.hepmc","inputIO11.hepmc");
}
