...
//GenEventData *hepmc3_event;
    ...
    Int_t           length_unit;
    Int_t           particles_;
    std::array<Int_t, kMaxparticles>           particles_pid;   //[particles_]
    std::array<Int_t, kMaxparticles>           particles_status;   //[particles_]
    std::array<Bool_t, kMaxparticles>          particles_is_mass_set;   //[particles_]
    std::array<Double_t, kMaxparticles>        particles_mass;   //[particles_]
    std::array<Double_t, kMaxparticles>        particles_momentum_m_v1;   //[particles_]
    std::array<Double_t, kMaxparticles>        particles_momentum_m_v2;   //[particles_]
    std::array<Double_t, kMaxparticles>        particles_momentum_m_v3;   //[particles_]
    std::array<Double_t, kMaxparticles>        particles_momentum_m_v4;   //[particles_]
    Int_t           vertices_;
    std::array<Int_t, kMaxvertices>           vertices_status;   //[vertices_]
    std::array<Double_t, kMaxvertices>        vertices_position_m_v1;   //[vertices_]
    std::array<Double_t, kMaxvertices>        vertices_position_m_v2;   //[vertices_]
    std::array<Double_t, kMaxvertices>        vertices_position_m_v3;   //[vertices_]
    std::array<Double_t, kMaxvertices>        vertices_position_m_v4;   //[vertices_]
    ...
    void Init(TChain *tree)
    {
        ...
        fChain->SetBranchAddress("particles.pid", particles_pid.data(), &b_particles_pid);
        fChain->SetBranchAddress("particles.status", particles_status.data(), &b_particles_status);
        fChain->SetBranchAddress("particles.is_mass_set", particles_is_mass_set.data(), &b_particles_is_mass_set);
        fChain->SetBranchAddress("particles.mass", particles_mass.data(), &b_particles_mass);
        fChain->SetBranchAddress("particles.momentum.m_v1", particles_momentum_m_v1.data(), &b_particles_momentum_m_v1);
        fChain->SetBranchAddress("particles.momentum.m_v2", particles_momentum_m_v2.data(), &b_particles_momentum_m_v2);
        fChain->SetBranchAddress("particles.momentum.m_v3", particles_momentum_m_v3.data(), &b_particles_momentum_m_v3);
        fChain->SetBranchAddress("particles.momentum.m_v4", particles_momentum_m_v4.data(), &b_particles_momentum_m_v4);
        fChain->SetBranchAddress("vertices", &vertices_, &b_hepmc3_event_vertices_);
        fChain->SetBranchAddress("vertices.status", vertices_status.data(), &b_vertices_status);
        fChain->SetBranchAddress("vertices.position.m_v1", vertices_position_m_v1.data(), &b_vertices_position_m_v1);
        fChain->SetBranchAddress("vertices.position.m_v2", vertices_position_m_v2.data(), &b_vertices_position_m_v2);
        fChain->SetBranchAddress("vertices.position.m_v3", vertices_position_m_v3.data(), &b_vertices_position_m_v3);
        fChain->SetBranchAddress("vertices.position.m_v4", vertices_position_m_v4.data(), &b_vertices_position_m_v4);
        ...
        fChain->SetBranchStatus("particles", true);
        fChain->SetBranchStatus("particles.pid", true);
        fChain->SetBranchStatus("particles.status", true);
        fChain->SetBranchStatus("particles.momentum.m_v1", true);
        fChain->SetBranchStatus("particles.momentum.m_v2", true);
...
//Comparison
    ...
    {
        const double eps = std::abs(H1.GetBinContent(i)-H2.GetBinContent(i));
